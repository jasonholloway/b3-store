...
final case class ProductView(
    ...
    name: String = "",
    price: Float = 0.0f
    ) extends com.trueaccord.scalapb.GeneratedMessage with com.trueaccord.scalapb.Message[ProductView] with com.trueaccord.lenses.Updatable[ProductView] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.woodpigeon.b3.schema.v100.ProductView = {
      var __sku = this.sku
    ...
    def withSku(__v: String): ProductView = copy(sku = __v)
    def withName(__v: String): ProductView = copy(name = __v)
    def withPrice(__v: Float): ProductView = copy(price = __v)
    ...
    def companion = com.woodpigeon.b3.schema.v100.ProductView
}

object ProductView extends com.trueaccord.scalapb.GeneratedMessageCompanion[com.woodpigeon.b3.schema.v100.ProductView] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[com.woodpigeon.b3.schema.v100.ProductView] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.woodpigeon.b3.schema.v100.ProductView = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.woodpigeon.b3.schema.v100.ProductView] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = com.woodpigeon.b3.schema.v100.ProductView(
  )
  implicit class ProductViewLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, com.woodpigeon.b3.schema.v100.ProductView]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, com.woodpigeon.b3.schema.v100.ProductView](_l) {
